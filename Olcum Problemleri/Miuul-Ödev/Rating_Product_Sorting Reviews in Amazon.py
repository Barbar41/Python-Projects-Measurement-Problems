...
#######################################################################################################
# Görev 1: Average Rating’i güncel yorumlara göre hesaplayınız var olan average rating ile kıyaslayınız
######################################################################################################
...
df=pd.read_csv("Olcum Problemleri/datasets/amazon_review.csv")
df["overall"].mean()
df.head()
...
# zaman bazlı ortalama ağırlıklarının belirlenmesi
